...
public class EditarCliente extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(txtCredito, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 290, 150, -1));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 340, -1, 40));
        ...
        getContentPane().add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 295, -1, -1));

        Wallpaper.setBackground(new java.awt.Color(255, 255, 204));
        Wallpaper.setOpaque(true);
        getContentPane().add(Wallpaper, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 320, 390));
    ...
    private void CapturarDatos() {
        ...
        if (Nombre.equals("") || NIT.equals("") || Telefono.equals("")) 
            ...
            ActualizarClienteMysql clienteMysql = new ActualizarClienteMysql();
            if(clienteMysql.ActualizarClienteMysql(cliente))
    ...
    private void setCliente(){
        ...
        txtCredito.setText(String.valueOf(cliente.getCreditoCompra()));
    }
