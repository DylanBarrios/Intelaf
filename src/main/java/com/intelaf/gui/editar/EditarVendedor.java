...
import com.intelaf.mysql.ActualizarVendedorMysql;
...
public class EditarVendedor extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel16.setText("Editar Vendedor");
    ...
    private void CapturarDatos() {
        ...
        if (Codigo.equals("") || Nombre.equals("") || Telefono.equals("") || DPI.equals("") || Direccion.equals("") || Correo.equals("")) {
            ...
            vendedor = new Vendedor(Codigo, Nombre, Telefono, DPI, NIT, Direccion, Correo);
            ActualizarVendedorMysql vendedorMysql = new ActualizarVendedorMysql();
            if(vendedorMysql.ActualizarVendedorMysql(vendedor))
    ...
    private void setVendedor(){
        ...
        txtDPI.setText(vendedor.getDPI());
        txtNIT.setText(vendedor.getNIT());
