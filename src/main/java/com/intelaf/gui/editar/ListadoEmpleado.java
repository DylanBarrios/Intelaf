 ...
 * @author dylan
 */
public class ListadoEmpleado extends javax.swing.JInternalFrame {
    ...
    public void Filtrar() {
        ...
        String sql = "SELECT * FROM Vendedor WHERE DPI LIKE '%" + DPI + "%' AND Nombre LIKE '%" + nombre + "%' ORDER BY Nombre ASC";
        ...
        try (Connection connection = conexion.getConnection()) {
            ...
            while (rs.next()) {
                ...
                Object datos[] = {Codigo, Nombre, Telefono, DPIbd};
                modelo.addRow(datos);
            }
        } catch (SQLException e) {
            System.out.println("Error al cargar empleados a editar " + e);
        }
    }

    private void Titulos() {
        String[] Titulos = {"Codigo", "Nombre", "Telefono", "DPI"};
    ...
    public void ClickTabla() {
        tableTiendas.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (FilaClick > -1) {
                    String Codigo = (String) modelo.getValueAt(FilaClick, ColumanClick);
                    DatosEmpleado(Codigo);
                    EditarVendedor editar = new EditarVendedor(empleado);
    ...
    public void DatosEmpleado(String Codigo) {
        Conexion conexion = new Conexion();
        
        String sql = "SELECT * FROM Vendedor WHERE Codigo = '" +Codigo+ "'";
        ...
        try (Connection connection = conexion.getConnection()) {
            ...
            while (rs.next()) {
                ...
                empleado = new Vendedor(Codigo, Nombre, Telefono, DPIbd, NIT, Direccion, Correo);
            }
        } catch (SQLException e) {
