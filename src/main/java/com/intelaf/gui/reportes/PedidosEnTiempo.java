 ...
 * @author dylan
 */
public class PedidosEnTiempo extends javax.swing.JInternalFrame {

    String CodigoTienda;
    DefaultTableModel modelo = null;

    public PedidosEnTiempo(String CodigoTienda) {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 49, 583, 371));
        getContentPane().add(txtHoy, new org.netbeans.lib.awtextra.AbsoluteConstraints(123, 7, 200, 29));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(335, 6, -1, -1));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(463, 6, -1, -1));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            e.generar(modelo, "Pedidos En Tiempo");
